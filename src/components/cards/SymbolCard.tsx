...
export const SymbolCard: React.FC<SymbolCardProps> = ({ symbol, onClick }) => {
  const renderSymbolSvg = (type: string) => {
    switch (type) {
      case 'dharmachakra':
        return (
          <svg viewBox="0 0 100 100" className="w-14 h-14 stroke-[#111111] group-hover:stroke-[#B8874A] fill-none stroke-[1.8] transition-colors">
            <circle cx="50" cy="50" r="40" />
            <circle cx="50" cy="50" r="12" fill="#F7F7F5" />
      ...
      case 'bodhitree':
        return (
          <svg viewBox="0 0 100 100" className="w-14 h-14 stroke-[#111111] group-hover:stroke-[#B8874A] fill-none stroke-[1.8] transition-colors">
            <path d="M50 88 L50 48" strokeWidth="2.5" />
      ...
      case 'stupa':
        return (
          <svg viewBox="0 0 100 100" className="w-14 h-14 stroke-[#111111] group-hover:stroke-[#B8874A] fill-none stroke-[1.8] transition-colors">
            ...
            <line x1="50" y1="42" x2="50" y2="18" strokeWidth="2" />
            <circle cx="50" cy="14" r="2.5" fill="#B8874A" />
          </svg>
        );
      case 'endlessknot':
        return (
          <svg viewBox="0 0 100 100" className="w-14 h-14 stroke-[#111111] group-hover:stroke-[#B8874A] fill-none stroke-[2] transition-colors">
      ...
      case 'footprints':
        return (
          <svg viewBox="0 0 100 100" className="w-14 h-14 stroke-[#111111] group-hover:stroke-[#B8874A] fill-none stroke-[1.6] transition-colors">
  ...
  return (
    <div
      onClick={onClick}
      className="group cursor-pointer bg-white border border-[#E4E4DF] hover:border-[#B8874A] transition-all p-6 sm:p-8 flex flex-col justify-between space-y-6"
    >
      <div className="flex items-start justify-between">
        <div className="p-3 bg-[#F7F7F5] border border-[#E4E4DF] group-hover:border-[#B8874A] transition-colors">
      ...
      <div className="pt-3 border-t border-[#E4E4DF] flex items-center justify-between text-xs font-mono text-[#111111] group-hover:text-[#B8874A]">
        <span className="uppercase tracking-widest text-[10px]">Symbolic Context</span>
        <span>→</span>
      </div>
    </div>
  );
